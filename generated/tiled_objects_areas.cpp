...
const std::array<BoxBounds, 13> Areas::bat_bounds = {
	...
	BoxBounds(4356.9415f,1349.71f,555.450333333333f,268.58f),
	BoxBounds(3439.108166666667f,1372.876666666667f,545.867f,242.08f),
	BoxBounds(4657.77466666667f,947.376666666667f,549.450666666666f,274.913333333333f),
	BoxBounds(3438.3165f,1214.71f,789.617f,99.08f),
	BoxBounds(4030.8165f,1375.46f,268.367f,242.08f),
	BoxBounds(4939.2744999999995f,2436.5434999999998f,747.451f,344.913f),
	BoxBounds(3410.2745f,2440.5434999999998f,773.451f,339.913f),
	BoxBounds(3538.2745f,2094.0434999999998f,572.451f,250.913f),
};
...
const std::array<BoxBounds, 7> Areas::lava = {
	BoxBounds(3440.0f,2039.272727272727f,592.0f,38.2272727272727f),
	...
	BoxBounds(3552.0f,2354.719683333333f,560.0f,77.7273f),
...
const std::array<BoxBounds, 5> Areas::rocket_launcher_awake = {
	...
	BoxBounds(5288.04f,1929.4585f,400.833f,351.0f),
...
const std::array<BoxBounds, 1> Areas::trigger_lava = {
	BoxBounds(1616.28403030303f,1134.909257575757f,195.038f,269.333f),
};
