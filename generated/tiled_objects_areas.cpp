...
const std::array<BoxBounds, 12> Areas::bat_bounds = {
	...
	BoxBounds(5673.265f,1559.0529999999999f,249.47f,66.894f),
...
const std::array<BoxBounds, 1> Areas::boss_bounds = {
	BoxBounds(3353.5f,1857.5f,476.333f,39.0f),
};

const std::array<BoxBounds, 15> Areas::explosion = {
	BoxBounds(7932.71f,1737.1595f,54.1515f,23.75f),
	BoxBounds(7617.27f,1741.5835f,48.7878f,23.75f),
	BoxBounds(7773.12f,1739.6734999999999f,57.7878f,23.75f),
	BoxBounds(7673.39f,1578.083166666667f,62.7878f,23.75f),
	BoxBounds(7812.889999999999f,1581.583166666667f,73.7878f,23.75f),
	BoxBounds(7885.889999999999f,1497.4165f,58.7878f,23.75f),
	BoxBounds(7892.72333333333f,1645.083166666667f,66.7878f,23.75f),
	BoxBounds(7727.22333333333f,1673.9165f,53.7878f,23.75f),
	BoxBounds(7579.72333333333f,1642.583166666667f,57.7878f,23.75f),
	BoxBounds(7979.72333333333f,1562.9165f,58.7878f,23.75f),
	BoxBounds(8126.4f,1498.4165f,58.7878f,23.75f),
	BoxBounds(8108.4f,1596.4165f,58.7878f,23.75f),
	BoxBounds(8037.389999999999f,1686.4165f,58.7878f,23.75f),
	BoxBounds(8109.4f,1738.4165f,58.7878f,23.75f),
	BoxBounds(7561.6061f,1482.125f,26.1211333333335f,61.4166666666667f),
};
...
const std::array<BoxBounds, 6> Areas::lava = {
	BoxBounds(5472.0f,1626.333f,368.0f,373.0f),
	...
	BoxBounds(6463.5f,1751.5f,178.0f,79.0000000000001f),
};

const std::array<BoxBounds, 1> Areas::parallax_cave = {
	BoxBounds(3910.83f,1567.25f,1543.67f,381.625f),
};

const std::array<BoxBounds, 1> Areas::parallax_forest = {
	BoxBounds(4422.5f,1185.5f,824.0f,289.5f),
};
