...
struct Tile {
	...
	// Aliases
	static constexpr Value BG_CAVE_CEILING_BEHIND_BREAKABLE = BG_32;
	static constexpr Value BG_DOOR_OPENING = BG_69;
	static constexpr Value BG_CAVE_FLOOR_BEHIND_BREAKABLE = BG_79;
