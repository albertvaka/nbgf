...
namespace Window {
	...
	namespace DrawPrimitive {
		...
		inline void Point(float x, float y, float thickness, const Color& c) { Point(x, y, thickness, c.r, c.g, c.b, c.a); }
		inline void Point(vec v, float thickness, const Color & c) { Point(v.x, v.y, thickness, c.r, c.g, c.b, c.a); }
		...
		inline void Rectangle(float x1, float y1, float x2, float y2, float thickness, const Color& c) {
			Rectangle(x1, y1, x2, y2, thickness, c.r, c.g, c.b, c.a);
		}
		inline void Rectangle(vec a, vec b, float thickness, const Color& c) {
			Rectangle(a.x, a.y, b.x, b.y, thickness, c.r, c.g, c.b, c.a);
		}
		inline void Rectangle(const BoxBounds& box, float thickness, const Color& c) {
		...
		inline void Line(float x1, float y1, float x2, float y2, float thickness, const Color& c) {
			Line(x1, y1, x2, y2, thickness, c.r, c.g, c.b, c.a);
		}
		inline void Line(vec v1, vec v2, float thickness, const Color & c) {
		...
		inline void Arrow(vec from, vec to, float thickness, float head_lenght, const Color& c) {
		...
		inline void Circle(float x, float y, float radius, float thickness, const Color& c) {
			Circle(x, y, radius, thickness, c.r, c.g, c.b, c.a);
		}
		inline void Circle(vec v, float radius, float thickness, const Color& c) {
			Circle(v.x, v.y, radius, thickness, c.r, c.g, c.b, c.a);
		}
		inline void Circle(const CircleBounds& bounds, float thickness, const Color& c) {
